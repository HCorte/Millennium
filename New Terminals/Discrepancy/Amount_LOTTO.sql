...
--FROM tl_t_wager 
--WHERE 
--wager_date >= TO_DATE('21.11.02 00:00:00','YY-MM-DD HH24:MI:SS') AND 
--wager_date < TO_DATE('21.11.03 00:00:00','YY-MM-DD HH24:MI:SS') AND
--CANCEL_DATE IS NULL AND --CANCEL_SERIAL_NUMBER IS NOT NULL AND
--draw_number = 88 --88 (Totoloto de Quarta) --89 (Totoloto de Sabado)

--                          COUNT            TOTAL AMT
-- TOTAL Sales              147              693    (Hades query a tl_t_wager draw_number=88)
-- Total sales              147              693.00 (MILL Totoloto de Quarta GIND=4) --> LOTQ-02-11-2021.DAT;1
-- Conclução os valores correspodem correctamente
