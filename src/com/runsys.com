$!
$! $Log:   GXAFXT:[GOLS]RUNSYS.COV  $
$! 
$!    Rev 1.1   18 Dec 1996 15:40:58   HXK
$! 
$!    Rev 1.1   29 Nov 1996  1:16:50   WXW
$! Telebetting startup, changes MP/PXN/WXW.
$! 
...
$ WRITE SYS$OUTPUT " "
$ WRITE SYS$OUTPUT " "
$ WRITE SYS$OUTPUT "Portugal ES Evolution System Startup"
$ WRITE SYS$OUTPUT " "
$ WRITE SYS$OUTPUT " "
$!
...
$!
$ RESET_PRCNAM := RESET		!SET TO "RESET" OR "REPROC"
$!
$!
