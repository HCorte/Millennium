C
C SUBROUTINE GNLAST
C $Log:   GXAFXT:[GOLS]GNLAST.FOV  $
C  
C     Rev 1.0   17 Apr 1996 13:26:32   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 16:31:48   DAB
C  Initial Release
...
* and will inform the requesting PC that no more messages
* will be sent for a previous request.
*
* Input parameters:
*
...
*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*
	SUBROUTINE GNLAST(MESTYP,SUBTYP,MSGID,MSGSEQ)
	IMPLICIT NONE
*
