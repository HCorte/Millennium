C  GXSRC:SIMICNF.FOR
C  
C  $Log:   GXAFXT:[GOLS]SIMICNF.FOV  $
C  
C     Rev 1.0   17 Apr 1996 15:06:28   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.3   22 Sep 1994  8:01:08   MCM
C  START INDEX AT 2 (BYTE 1 IS RESERVED)
C  
C     Rev 1.2   08 Sep 1994 13:26:50   MCM
C  SW3APPING BYTES IS NO LONGER NECESSARY ON THE DEC LMS
C  
C     Rev 1.1   03 Jan 1994 22:45:08   SYSTEM
C  Applying PVCS header for automatic revision history
C  
C     Rev 1.0    21 Dec 1993 18:30:26   SYSTEM
C  Initial revision.
C
C
C
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE SIMICNF(OUTTAB,TRABUF)
	IMPLICIT NONE
C
