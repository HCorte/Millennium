...
C
C  $Logfile::   GXAFXT:[GOLS]X2SETNOPOLL.FOV                              $
C  $Date::   17 Apr 1996 16:34:06                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++            
C                                                                               
      SUBROUTINE X2SETNOPOLL(SUBNETWORK,FIRST_STATION
     *						  ,LAST_STATION)
      IMPLICIT NONE                                                             
...
C                                                                               
	    CALL ILBYTE(TEMP, IX2XS_PARAM, OFF - 1)                            
	    TEMP = IOR(TEMP, X2XS_NO_POLL)                                         
	    CALL ISBYTE(TEMP, IX2XS_PARAM, OFF - 1)                            
