C
C SUBROUTINE NP_RNG_SAP
C $Log:   GXAFXT:[GOLS]NP_RNG_SAP.FOV  $
C  
C     Rev 1.0   17 Apr 1996 14:14:00   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 17:08:48   DAB
C  Initial Release
...
*
* V01 14-JUN-90 MRM INITIAL RELEASE.
*
* GNOS network port qualification 1 switch routines.
* Qualification 1 for netport port messages refer
* to SAP values.
*
...
*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*
	SUBROUTINE NP_RNG_SAP(MESTYP,SUBTYP,MSGID,
