C SUBROUTINE PRINTRA_BEF_5626
C
C PRINTRA_BEF_5626.FOR (SINCE V54)
C
C V54 04-JUL-2016 SCML M16 PROJECT
C ----------------------------------------------------------------------
...
C
C SUBROUTINE TO PRINT TRANSACTIONS IN TMIR FORMAT BEFORE M16 PROJECT (SINCE V54)
C
C
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C       SUBROUTINE PRINTRA(TRABUF,PUNIT,DETAIL,LLINCNT,SCRAM,TOTAL,CARY)
        SUBROUTINE IGS_PRINTRA_BEF_5626(TRABUF,PUNIT,DETAIL,LLINCNT,
     *                                 SCRAM,TOTAL,CARY)
C----+------------------------------------------------------------------
C V53| TMIR Report generation bug fix
C----+------------------------------------------------------------------
...
C----+------------------------------------------------------------------
        ...
        LINCNT = LLINCNT
        GOTO 11111
        ENTRY PRINTRA_BEF_5626(TRABUF,PUNIT,DETAIL,SCRAM,TOTAL,CARY)
...
C            WRITE(PUNIT,971) HMSGID ! MESSAGE ID
            WRITE(PUNIT,971) TRABUF(TSDT1), TRABUF(TSDT2), HMSGID ! MESSAGE ID
            LINCNT = LINCNT + 1
          ENDIF
C
C V52 - End
...
C     *          , 1X, ' AGT TO REP > ',A8, /)
9041    FORMAT(10X,'Class> ',I3 ,1X,' Subclass> ',I3, 1X, ' Cycle> ',I3.3,'/', I4.4
...
971     FORMAT(10X,'Class> ',I0,1X, ' Subclass> ',I0,1X, ' Host Message ID> ',I0)
C V52 - End
