C
C SUBROUTINE WTAPEW
C $Log:   GXAFXT:[GOLS]WTAPEW.FOV  $
C  
C     Rev 1.0   17 Apr 1996 16:05:46   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 18:09:36   DAB
C  Initial Release
...
C*********************************************************************
C
C *** WTAPEW	  WRITE BLOCK WITH WAIT
C
C*********************************************************************
C
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE WTAPEW(FDB,BUFFER,STATUS)
	IMPLICIT NONE
C
...
C
	NUMTRY = 0
1000	CONTINUE
	STATUS=SYS$QIOW ( , %VAL(CHAN), %VAL(IO$_WRITEPBLK),
     1		        FDB(TAPFDB_IOSB),,,
     1	                BUFFER, %VAL(IOLEN), ,,,)
C
C
