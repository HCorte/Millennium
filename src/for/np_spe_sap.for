C
C SUBROUTINE NP_SPE_SAP
C $Log:   GXAFXT:[GOLS]NP_SPE_SAP.FOV  $
C  
C     Rev 1.0   17 Apr 1996 14:14:20   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 17:09:04   DAB
C  Initial Release
...
*
* ========================================================
* SUBROUTINE NP_SPECIFIC_SAP
*
	SUBROUTINE NP_SPE_SAP(MESTYP,SUBTYP,MSGID,
