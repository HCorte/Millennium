C
C SUBROUTINE BACK
C $Log:   GXAFXT:[GOLS]BACK.FOV  $
C  
C     Rev 1.0   17 Apr 1996 12:14:30   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 15:40:50   DAB
C  Initial Release
...
C*********************************************************************
C
C *** BACK	SKIP ONE RECORD BACKWARD
C
C*********************************************************************
C
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE BACK  (FDB,STATUS)
	IMPLICIT NONE
C
