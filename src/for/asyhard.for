C
C PROGRAM ASYHARD
C $Log:   GXAFXT:[GOLS]ASYHARD.FOV  $
C  
C     Rev 1.0   17 Apr 1996 12:13:52   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   06 Oct 1993 18:11:10   LMK
C  Initial revision.
C  
C
C ** Source - ASYHARD.for;1 **
C
C ASYHARD.FOR
C
...
C
        TYPE *
        TYPE *,'<<<<< ASYHARD X2X Broadcasting Facility >>>>>'
        TYPE *
C
10	CONTINUE
	GRPCNT=0
