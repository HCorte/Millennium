...
C
C SUBROUTINE TO BUILD INSTANT CAR OUTPUT MESSAGES.
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE OICAR(TRABUF,OUTTAB,OUTLEN)
	IMPLICIT NONE
C
...
C INSTANT CLASS
C
	OUTTAB(IND) = TRABUF(TCCLS)
	IND=IND+1
C
C PACK COUNT
C
	CALL HOST_TO_TERM(OUTTAB(IND), TRABUF(TCCNT), 2)
	IND=IND+2
C
	OUTLEN=IND-1
C
