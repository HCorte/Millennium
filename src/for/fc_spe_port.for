C
C SUBROUTINE FC_SPE_PORT
C $Log:   GXAFXT:[GOLS]FC_SPE_PORT.FOV  $
C  
C     Rev 1.0   17 Apr 1996 13:08:54   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 16:16:16   DAB
C  Initial Release
...
*
* ========================================================
* SUBROUTINE FC_SPE_PORT
*
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE FC_SPE_PORT(MESTYP,SUBTYP,MSGID,
