...
C
C SUBROUTINE TO DECODE INSTANT ORDER-PACK ACTIVATION MESSAGE FROM TERMINAL
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE DIOACT(TERMES,TRABUF,MESLEN)
	IMPLICIT NONE
C
...
C
	CALL TERM_TO_HOST(TERMES(IND),TRABUF(TOINV2),2)
	IND=IND+2
C
	CALL TERM_TO_HOST(TERMES(IND),TRABUF(TOINV3),4)
	IND=IND+4
C
