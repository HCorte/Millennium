C
C SUBROUTINE NET_CHKBUF_AST
C
C*************************** START X2X PVCS HEADER ****************************
C
C  $Logfile::   GXAFXT:[GOLS]NET_CHKBUF_AST.FOV                           $
C  $Date::   17 Apr 1996 14:10:50                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
C**************************** END X2X PVCS HEADER *****************************
C  
C *** Pre-Baseline Source - net_chkbuf_ast.for ***
C
C++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C
	SUBROUTINE NET_CHKBUF_AST(BUFFER, NODE, NODE_USEID, RETURN_STATUS)
C
	IMPLICIT NONE
C
