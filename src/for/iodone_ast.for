C
C *** SUBROUTINE IODONE_AST ***
C
C*************************** START X2X PVCS HEADER ****************************
C
C  $Logfile::   GXAFXT:[GOLS]IODONE_AST.FOV                               $
C  $Date::   17 Apr 1996 13:39:50                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
...
C
	CALL ABL_AST(BUFFER.BUF_NO, DCN_NETQUE, STATUS)
C
