C
C SUBROUTINE NP_RNG_PORT
C $Log:   GXAFXT:[GOLS]NP_RNG_PORT.FOV  $
C  
C     Rev 1.0   17 Apr 1996 14:13:56   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 17:08:42   DAB
C  Initial Release
...
*
* GNOS network port qualification 2 switch routines.
...
*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
*
	SUBROUTINE NP_RNG_PORT(MESTYP,SUBTYP,MSGID,
