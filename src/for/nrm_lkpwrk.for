C
C SUBROUTINE LKPWRK
C $Log:   GXAFXT:[GOLS]LKPWRK.FOV  $
C  
C     Rev 1.0   17 Apr 1996 13:50:20   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 16:51:32   DAB
C  Initial Release
...
C
C******************************************************************
C	LKPWRK(FSTPAG, LSTPAG)
C******************************************************************
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE LKPWRK(FSTPAG, LSTPAG)
	IMPLICIT NONE
C
