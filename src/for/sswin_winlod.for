C
C SUBROUTINE SSWIN_WINLOD
C $Log:   GXAFXT:[GOLS]SWIN_WINLOD.FOV  $
C  
C V01 14-JAN-99 GPW STOPSYS OPTIMIZATION (COPIED FROM SWIN_WINLOD)
C
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE SSWIN_WINLOD(FUN,RECORD)
	IMPLICIT NONE
C
...
C
100	CONTINUE
        CALL WINGETW('SSWINTSK',NAMVLW,NAMTCW)                    !V01
