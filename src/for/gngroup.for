C
C SUBROUTINE GNGROUP
C $Log:   GXAFXT:[GOLS]GNGROUP.FOV  $
C  
C     Rev 1.0   17 Apr 1996 13:26:16   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 16:31:30   DAB
C  Initial Release
...
*
* This subroutine will build the requested group description
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE GNGROUP(MESTYP,SUBTYP,MSGID,TYP,CNT,QUADTA)
	IMPLICIT NONE
*
...
*
	...
	IF(TYP(1).EQ.GNHDRMES_TYP_RANGE) THEN
	  DO 100 OUTGRP=QUADTA(1,1),QUADTA(2,1)
	    CALL BLDGRP(OUTGRP,MESTYP,SUBTYP,MSGID,MSGSEQ,MESLEN)
100	  CONTINUE
*
