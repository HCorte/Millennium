C
C SUBROUTINE FC_ALL_SAP
C $Log:   GXAFXT:[GOLS]FC_ALL_SAP.FOV  $
C  
C     Rev 1.0   17 Apr 1996 13:08:42   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 16:15:50   DAB
C  Initial Release
...
*
* ========================================================
* SUBROUTINE FC_ALL_SAP
*
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE FC_ALL_SAP(MESTYP,SUBTYP,MSGID,
...
*
	DO 100 SAP=X2X_ACTUAL_SAP,X2X_SAP
