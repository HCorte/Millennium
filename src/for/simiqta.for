C  GXSRC:SIMIQTA.FOR
C  
C  $Log:   GXAFXT:[GOLS]SIMIQTA.FOV  $
C  
C     Rev 1.0   17 Apr 1996 15:07:14   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.3   22 Sep 1994  8:07:20   MCM
C  START INDEX AT 2 (BYTE 1 IS RESERVED)
C  
C     Rev 1.2   08 Sep 1994 13:35:58   MCM
C  SWAPPING BYTES IS NO LONGER NECESSARY ON THE DEC LMS
C  
C     Rev 1.1   03 Jan 1994 22:46:36   SYSTEM
C  Applying PVCS header for automatic revision history
C  
C     Rev 1.0    21 Dec 1993 18:30:50   SYSTEM
C  Initial revision.
C
C
C
...
C
C SUBROUTINE TO FILL IN CROSS SYSTEM QUOTA REPORT MESSAGE.
C
C
C
C
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE SIMIQTA(OUTTAB,TRABUF)
	IMPLICIT NONE
C
