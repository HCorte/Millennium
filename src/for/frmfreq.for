C
C SUBROUTINE FRMFREQ
C
C*************************** START X2X PVCS HEADER ****************************
C
C  $Logfile::   GXAFXT:[GOLS]FRMFREQ.FOV                                  $
C  $Date::   17 Apr 1996 13:13:46                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
...
C  DEC Baseline
C
C ** Source - frmfreq.for;1 **
C
C FRMFREQ.FOR
C
C V01 28-NOV-90 XXX RELEASED FOR VAX
C
C CALL FRMFREQ(SSAP,DSAP,BUF)
C
C IN:
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE FRMFREQ(SSAP,DSAP,BUF)
	IMPLICIT NONE
C
