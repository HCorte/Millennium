...
C V03 31-MAY-2000 PXO Subroutine name PTSSNP -> TPTSNP
C V02 10-MAY-1999 UXN TRIPLE CHANGED TO TRIO. TRSSNP CHANGED TO PTSSNP.
...
9001	FORMAT ('Today''s Trio Sales for ',7A2,' *')
