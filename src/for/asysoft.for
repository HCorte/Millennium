C
C PROGRAM ASYSOFT
C $Log:   GXAFXT:[GOLS]ASYSOFT.FOV  $
C  
C     Rev 1.0   17 Apr 1996 12:14:06   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   06 Oct 1993 18:11:14   LMK
C  Initial revision.
C  
C
C ** Source - ASYSOFT.for;1 **
C
C ASYSOFT.FOR
C
...
C
        TYPE *
        TYPE *,'<<<<< ASYSOFT X2X Broadcasting Facility >>>>>'
        TYPE *
C
10	CONTINUE
	GRPCNT=0
