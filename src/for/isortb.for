C  GXSRC:ISORTB.FOR
C  
C  $Log:   GXAFXT:[GOLS]ISORTB.FOV  $
C  
C     Rev 1.0   18 Dec 1996 12:23:00   HXK
C  Initial revision.
C  
C     Rev 1.1   28 Nov 1996 23:32:38   WXW
C  Applying PVCS header for automatic revision history
C  
C     Rev 1.0    28 Nov 1996 23:30:22   WXW
C  Initial revision.
C  
C ISORTA.FTN                                                                    
C                                                                               
...
C                                                                               
C THIS WILL PERFORM A SHELL SORT OF A SIZ - DIMENSION I*4 ARRAY                    
C                                                                               
C                                                                               
C CALLING SEQUENCE:                                                             
C     CALL ISORTA(I4ARAY,CNT,IND,SIZ)                                               
C INPUT                                                                         
C     CNT   - NUMBER OF ITEMS TO SORT                                           
C     SIZ   - NUMBER OF ITEMS IN ARRAY                                           
...
C=======OPTIONS/CHECK=NOOVERFLOW/EXT
      SUBROUTINE ISORTB(I4ARAY,CNT,IND,SIZ)                  
      IMPLICIT NONE


      INTEGER*4 CNT,SIZ
      INTEGER*4 I4ARAY(SIZ,CNT)                                                  
