C
C PROGRAM X21HARD
C $Log:   GXAFXT:[GOLS]X21HARD.FOV  $
C  
C     Rev 1.0   17 Apr 1996 16:06:38   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   06 Oct 1993 18:11:24   LMK
C  Initial revision.
C  
C
C ** Source - X21HARD.for;1 **
C
C X21HARD.FOR
C
...
C
        TYPE *
        TYPE *,'<<<<< X21HARD X2X Broadcasting Facility >>>>>'
        TYPE *
C
10	CONTINUE
	GRPCNT=0
