...
C
C SUBROUTINE TO DEFINE TODAY'S COUPLE GAME PARAMETERS.
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C---- Local variables.
	...
	INTEGER*4  CDCPTIM	    !closing time
	INTEGER*4  CDCPPRC	    !base price
	INTEGER*4  CDCPSPR	    !pool percentage
...
10	CALL CLRSCR(5)
	...
	WRITE(5,710) DISTIM(CDCPTIM)

	WRITE(5,720) CMONY(CDCPPRC,10,BETUNIT)

	WRITE(5,730) DISPER(CDCPSPR)

        DO I = 2, MAXMLTD_AVL
          IF (DCPMDS(I) .NE. 0) THEN
            WRITE(5,9190) I
          END IF
        END DO
...
510	CONTINUE
	...
	CALL READW(FDB,DRAW,DCPREC,STATUS)
