...
C
      OUTMSG(IDXMSG + 0) = WEEK ! IDXMSG=15 + 0 -> 15 (First Week Draw Date)
      OUTMSG(IDXMSG + 1) = YEAR - 2000 ! IDXMSG=15 + 1 -> 16 (First Year Draw Date)
      IDXMSG = IDXMSG + 2 ! IDXMSG=15+2=17
C
...
C
      OUTMSG(IDXMSG + 0) = WEEK ! IDXMSG=17 + 0 -> 17 (Second Week Draw Date)
      OUTMSG(IDXMSG + 1) = YEAR - 2000 ! IDXMSG=17 + 1 -> 18 (Second Year Draw Date)
      IDXMSG = IDXMSG + 2 ! IDXMSG=17+2=19    
C
