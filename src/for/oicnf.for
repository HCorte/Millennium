...
C V07 16-JAN-1997 HXK Initialis error byte before setting ... 
C V06 13-JAN-1997 HXK Fixed error code checking
...
C
C SUBROUTINE TO BUILD INSTANT ORDER CONFIRMATION OUTPUT MESSAGES.
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE OICNF(TRABUF,OUTTAB,OUTLEN)
	IMPLICIT NONE
C
