...
C       ************************************************************
	SUBROUTINE OPEN_OPS (ACCESS_TYPE, ST)
C       ************************************************************
C       Routine to open OPS.FIL file 
C       ************************************************************
	IMPLICIT NONE
	...
	INCLUDE 'INCLIB:OPS_REC.DEF'
        ...
        CHARACTER*20 ACCESS_TYPE   !(INPUT)  CONTAINS 'SEQUENTIAL' OR 'KEYED'
        INTEGER*4    ST            !(OUTPUT) STATUS FOR OPEN

	ST = 0

        IF (ACCESS_TYPE(1:5).EQ.'KEYED') THEN
	   OPEN (UNIT           =  OPS_LUN,
     *           FILE           = 'FILE:OPS.FIL',
     *           STATUS         = 'OLD',
     ...
     *           RECORDTYPE     = 'FIXED',
     *           IOSTAT         =  ST)
        ELSEIF (ACCESS_TYPE(1:10).EQ.'SEQUENTIAL') THEN
	   OPEN (UNIT           =  OPS_LUN,
     *           FILE           = 'FILE:OPS.FIL',
     *           STATUS         = 'OLD',
     *           ORGANIZATION   = 'INDEXED',
