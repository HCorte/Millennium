...
C V03 31-MAY-2000 PXO Subroutine name TSUKSNP -> TSKSNP
...
C---- Local integer variables.
	...
	LOGICAL ACTIVE_GAMES   ! THERE ARE ACTIVE GAMES OR NOT

...
9001	FORMAT ('Super Kaks Game Sales for ',7A2)
...
905     FORMAT(X, 'There Are Not Active Super Kaks Games, Enter Vision Command')
