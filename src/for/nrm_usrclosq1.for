C
C SUBROUTINE USRCLOSQ1
C $Log:   GXAFXT:[GOLS]USRCLOSQ1.FOV  $
C  
C     Rev 1.0   17 Apr 1996 15:44:52   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 17:59:26   DAB
C  Initial Release
...
C
	IF(LUN.LT.1 .OR. LUN.GT.MAXLUNARRAY)THEN
	  TYPE *,IAM(),'BAD LUN IN VAX_DISKQIO/USRCLOS1 = ',LUN
