C
C SUBROUTINE BEOT
C $Log:   GXAFXT:[GOLS]BEOT.FOV  $
C  
C     Rev 1.0   17 Apr 1996 12:15:36   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 15:41:36   DAB
C  Initial Release
...
C******************************************************************
C
C *** BEOT	SKIP FILE BACKWARD
C
C******************************************************************
C
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE BEOT (FDB, STATUS)
	IMPLICIT NONE
C
...
C
	NUMTRY = 0
1000	CONTINUE
	STATUS=SYS$QIOW ( , %VAL(CHAN), %VAL(IO$_SKIPFILE),
     1		        FDB(TAPFDB_IOSB),,,
     1	                %VAL(-1), , ,,,)
C
C
