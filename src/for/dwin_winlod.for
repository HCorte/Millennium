C
C SUBROUTINE DWIN_WINLOD
C $Log:   GXAFXT:[GOLS]DWIN_WINLOD.FOV  $
C  
C V01 14-JAN-99 GPW STOPSYS OPTIMIZATION
C
C     Rev 1.0   17 Apr 1996 13:02:54   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   23 Nov 1995 14:19:26   PXB
C  Initial revision.
C
...
C=======OPTIONS /CHECK=NOOVERFLOW
	...
	SUBROUTINE DWIN_WINLOD(FUN,RECORD)
...
100	CONTINUE
        ...
        CALL WINGETW('DWINTSK ',NAMVLW,NAMTCW)                    ! V01
