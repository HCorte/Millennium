...
C
C TODAY'S TRIO WINNER SELECTION PROCEDURE CONTROL TASK
C
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C---------------------------- Start of code ------------------------------
	...
	CALL PRMYESNO(
     *   'Are you sure you want Todays Trio winner selection [Y/N]? ',
     *   FLAG)
...
C---- Load and start cwinsel task
	...
	WRITE(5,901) IAM(),'TRWINSEL'

	CALL RUNTSK(8HTRWINSEL)
...
900	FORMAT(1X,A,' Mount drawing packs and continue TRWINTSK ')

901	FORMAT(1X,A,' Begining execution of ',A8)

902	FORMAT(1X,A,' Todays Trio winner selection complete ')
