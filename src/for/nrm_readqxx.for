C
C SUBROUTINE READQXX
C $Log:   GXAFXT:[GOLS]READQXX.FOV  $
C  
C     Rev 1.0   17 Apr 1996 14:38:56   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 17:27:26   DAB
C  Initial Release
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE READQXX(FDB, BLOCK, BUFFER, STATUS)
	IMPLICIT NONE
C
...
C
	STATUS=SYS$QIO (%VAL(FLAG), %VAL(CHAN), %VAL(IO$_READVBLK),
     1		        FDB(FDB_IOSB),,,
