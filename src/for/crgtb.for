...
C V02 07-MAY-1993 MCM RELEASED FOR GEORGIA
C V01 08-APR-1992 JPJ RELEASED FOR VAX (INSTANTS)
C
C SUBROUTINE TO BUILD CROSS SYSTEM GAME TABLE MESSAGE.
C
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE CRGTB(OUTTAB,TRABUF,BUF)
	IMPLICIT NONE
C
...
C
	...
	IND=IND+2
C
C SET GAME NUMBER ONE
C
	I4TEMP=TRABUF(TIGMN+0)
	OUTTAB(IND+0) = I1TEMP(1)
	OUTTAB(IND+1) = I1TEMP(2)
	IND=IND+2
C
C SET GAME NUMBER TWO
C
	I4TEMP=TRABUF(TIGMN+1)
	OUTTAB(IND+0) = I1TEMP(1)
	OUTTAB(IND+1) = I1TEMP(2)
	IND=IND+2
C
