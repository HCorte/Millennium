...
C
C  $Logfile::   GXAFXT:[GOLS]NETDUMP.FOV                                  $
C  $Date::   17 Apr 1996 14:10:00                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
C**************************** END X2X PVCS HEADER *****************************
C
C V01 23-DEC-94 GPR Released for UK
C  
C *** Pre-Baseline Source - netdump.for ***
C
C++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C
C Purpose:
C	UTILITY ROUTINE TO DUMP NETMGR/NETLOG COMMONS TO A FILE AND RESTORE.
C
C++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C
...
C
	TYPE *, IAM(), 'RESTORING NET COMMONS'
	CALL NET_RESTORE
	CALL XWAIT(5, 2, ST)
	GOTO 100
C
...
C FORMAT STATEMENTS.
C
9000	FORMAT(////, T22, '    GTECH NET DUMP    ', /,
     *               T22, '1. DUMP NET COMMONS   ', /,
     *               T22, '2. RESTORE NET COMMONS', /,
     *               T22, 'E. EXIT               ', //)
