C
C SUBROUTINE FLUSHAPP
C
C*************************** START X2X PVCS HEADER ****************************
C
C  $Logfile::   GXAFXT:[GOLS]FLUSHAPP.FOV                                 $
C  $Date::   17 Apr 1996 13:11:52                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
...
100	CONTINUE
	CALL RTL(BUF,LANAPP(1,QUE),STATUS)
