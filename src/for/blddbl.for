...
C
C SUBROUTINE TO DEFINE SUPER DOUBLE GAME PARAMETERS.
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C---- Local variables.
	...
	INTEGER*4  CDDBTIM	    !closing time
	INTEGER*4  CDDBPRC	    !base price
	INTEGER*4  CDDBSPR	    !pool percentage
...
10	CALL CLRSCR(5)
	...
	WRITE(5,710) DISTIM(CDDBTIM)

	WRITE(5,720) CMONY(CDDBPRC,10,BETUNIT)

	WRITE(5,730) DISPER(CDDBSPR)

        DO I = 2, MAXMLTD_AVL
          IF (DDBMDS(I) .NE. 0) THEN
            WRITE(5,9190) I
          END IF
        END DO
...
510	CONTINUE
	...
	CALL READW(FDB,DRAW,DDBREC,STATUS)
