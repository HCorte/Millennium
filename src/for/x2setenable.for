...
C
C  $Logfile::   GXAFXT:[GOLS]X2SETENABLE.FOV                              $
C  $Date::   17 Apr 1996 16:33:56                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++            
C                                                                               
      SUBROUTINE X2SETENABLE(SUBNETWORK,FIRST_STATION
     *						  ,LAST_STATION)
      IMPLICIT NONE                                                             
...
C                                                                               
	    CALL ISBYTE(X2XS_IDLE,IX2XS_STATE,OFF-1)                           
