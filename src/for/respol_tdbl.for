...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C
	SUBROUTINE RESPOL_TDBL(GNUM, CDC, TIME)
	IMPLICIT NONE
...
C Initialize pools
C
	CALL FASTSET(0,DDBODT,MAXDBLRW*MAXDBLRW)
C
C Set date&time
C
	DDBLAT(LATCDC) = CDC
...
C
	FILCNT = 0
	CALL SETDFN(GNUM, DDBBSD, DDBESD, VOL, CFILES, FILCNT)
	CALL GETLUN(LUN)
C
