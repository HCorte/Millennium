C
C PROGRAM LSIM
C $Log:   GXAFXT:[GOLS]LSIM.FOV  $
C  
C     Rev 1.0   17 Apr 1996 13:56:28   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.1   19 Oct 1993 16:55:08   LMK
C  CREATED A VALID W1BUF (LOTTO 1 WAGER)
C  
C     Rev 1.0   21 Jan 1993 16:56:24   DAB
C  Initial Release
...
C 3 DIGIT NUMBERS
C
     *   Z21,Z04,Z00,Z00,Z00,Z00,Z10,Z11,Z00,Z51,
     *   Z12,Z3F,Z00,Z00,Z00,Z00,Z00,Z00,Z00,Z00,
     *   76*0,
C
C 4 DIGIT NUMBERS
C
...
C
     ...
     *   Z20,Z19,Z00,Z00,Z00,Z00,Z00,Z00,Z00,Z00,Z00,Z00,84*0/
C
	DATA L/49,90,11,11,20*12/
C
C
	CALL COPYRITE
C
	TYPE *,IAM(),'LSIM  SIMULATOR'
	TYPE *,IAM()
C
C
	P(SUPWAG)=0
...
C
15	CONTINUE
	CALL INPNUM('Enter number of Lotto 1 bets  ',PER(1),0,N,EXT)
	IF(EXT.NE.0) CALL GSTOP(GEXIT_OPABORT)
	CALL INPNUM('Enter number of Lotto 2 bets  ',PER(2),0,N,EXT)
	IF(EXT.NE.0) CALL GSTOP(GEXIT_OPABORT)
	CALL INPNUM('Enter number of Toto 1 bets  ',PER(3),0,N,EXT)
	IF(EXT.NE.0) CALL GSTOP(GEXIT_OPABORT)
	CALL INPNUM('Enter number of Toto 2 bets  ',PER(4),0,N,EXT)
	IF(EXT.NE.0) CALL GSTOP(GEXIT_OPABORT)
	CALL INPNUM('Enter number for VALPRO       ',PER(5),0,N,EXT)
	IF(EXT.NE.0) CALL GSTOP(GEXIT_OPABORT)
C
