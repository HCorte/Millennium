C
C SUBROUTINE DN_AP_STATUS
C
C*************************** START X2X PVCS HEADER ****************************
C
C  $Logfile::   GXAFXT:[GOLS]DN_AP_STATUS.FOV                             $
C  $Date::   17 Apr 1996 12:56:34                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
...
C returned
C 
C *** NOTE: If you change this change the version at the end of the file.
C
C INPUT
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE DN_AP_STATUS(BUFFER,STATUS)
C
