C
C SUBROUTINE SRT
C $Log:   GXAFXT:[GOLS]SRT.FOV  $
C  
C     Rev 1.0   17 Apr 1996 15:17:24   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 17:42:52   DAB
C  Initial Release
...
C====================================================================
C     SORT BET NUMBERS
C     1-ST BET-2 SORTED AND LAST 2 SORTED
C
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE SRT(TAB1,TAB2,BET)
	IMPLICIT NONE
C
