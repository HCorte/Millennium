C
C SUBROUTINE X2BROMOD
C
C*************************** START X2X PVCS HEADER ****************************
C
C  $Logfile::   GXAFXT:[GOLS]X2BROMOD.FOV                                 $
C  $Date::   17 Apr 1996 16:11:22                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
...
C
C This subroutine will update the X2X Relay Broadcast
C parameters.
C
C
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C
	...
	UPDATE=.TRUE.
	CALL X2BSET(X2XBRO_BITMAP,FIELD,XBRO,REC)			    !V02
	CALL CLRSCR(5)
	WRITE(5,9000)
	GOTO 50
C
