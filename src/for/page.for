...
C            CALL OPS("REMOVE LOGICAL",STAT_LOGICAL,0)
            FROMSNAP_OLM = 0
...
8023    CONTINUE
        ...
        CALL OLMSNP(SLINE)
CCCCCCCCCCCCCCCCCCCCCC activate the flag thats entered olm snapshot
        FROMSNAP_OLM = 1
CCCCCCCCCCCCCCCCCCCCCC could define a array that would indicate 
CCCCCCCCCCCCCCCCCCCCCC by its position from witch snapshot it come from
        GOTO 60          
C
8024    CONTINUE
