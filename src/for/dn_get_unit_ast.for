C
C SUBROUTINE DN_GET_UNIT_AST
C
C*************************** START X2X PVCS HEADER ****************************
C
C  $Logfile::   GXAFXT:[GOLS]DN_GET_UNIT_AST.FOV                          $
C  $Date::   17 Apr 1996 12:58:12                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C        
	SUBROUTINE DN_GET_UNIT_AST (CHAN, UNIT)
	IMPLICIT NONE
C  DN_GET_UNIT_AST
C  John W Elliott					     20-Apr-1991
C  John A Harney                                             17-Apr-1991
C
C  Subroutine to return the unit number associated with a channel
C
C  Calling sequence:
C	CALL DN_GET_UNIT_AST (CHAN, UNIT)
