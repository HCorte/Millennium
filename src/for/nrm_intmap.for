C
C SUBROUTINE INTMAP
C $Log:   GXAFXT:[GOLS]INTMAP.FOV  $
C  
C     Rev 1.0   17 Apr 1996 13:39:00   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 16:40:40   DAB
C  Initial Release
C  Based on Netherlands Bible, 12/92, and Comm 1/93 update
C  DEC Baseline
C
C ** Source - nrm_intmap.for **
C
C VAX_INTMAP.FOR
C
...
C
C ...... INTMAP    INTERVAL CODING TO BIT MAPPING
C
C CALLING SEQUENCE:
C
C        CALL INTMAP(TERMES,INDEX,NBOARD,SYSTEM,MAXNUM,BITMAP,ST)
C
C INPUT:
C
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE INTMAP(TERMES,INDEX,NBOARD,SYSTEM,MAXNUM,BITMAP,ST)
	IMPLICIT NONE
C
	BYTE	    TERMES(*)
	INTEGER*4   INDEX
