...
C
C  $Logfile::   GXAFXT:[GOLS]X2SETDISABLE.FOV                             $
C  $Date::   17 Apr 1996 16:33:52                                         $
C  $Revision::   1.0                                                      $
C  $Author::   HXK                                                        $
C
...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++            
C                                                                               
      SUBROUTINE X2SETDISABLE(SUBNETWORK,FIRST_STATION
     *						  ,LAST_STATION)
      IMPLICIT NONE                                                             
...
C                                                                               
	    CALL ISBYTE(X2XS_DISABLED,IX2XS_STATE,OFF-1)                           
