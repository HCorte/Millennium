C
C SUBROUTINE GETCMB
C $Log:   GXAFXT:[GOLS]GETCMB.FOV  $
C  
C     Rev 1.0   17 Apr 1996 13:19:16   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 16:24:42   DAB
C  Initial Release
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE GETCMB(INDTAB,BET,IND)
	IMPLICIT NONE
C
...
C
	...
	INTEGER*4 INDTAB(IND,*)    !TABLE WITH COMBINATIONS OF ELEMENTS
C
	INTEGER*4 INDEX(20)
C
	NEXT=1
