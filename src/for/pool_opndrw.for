C
C SUBROUTINE POOL_OPNDRW
C $Log:   GXAFXT:[GOLS]POOL_OPNDRW.FOV  $
C  
C     Rev 1.0   17 Apr 1996 14:26:52   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 17:20:20   DAB
C  Initial Release
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE POOL_OPNDRW(FILE,UNT)
	IMPLICIT NONE
C
