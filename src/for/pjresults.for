...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
C
C CREATES FILES PJMC_NS_GGWWYYYY.ASC WIDH RESULTS NUMBERS
...
C
        ...
        TYPE*,IAM(),'              GENERATES FILES OF RESULTS               '
        TYPE*,IAM(),'                 PJMC_NS_GGWWYYYY.ASC                  '
...
C**********************************************
	IF(GTYP .EQ. TINS .OR. GTYP .EQ. TTGL) THEN
...
110     CONTINUE
	...
	IF(GTYP.EQ.TLTO) THEN 
	   CALL PJLTORESULTS(FILE,DRAW,GNUM,GIND)
        ELSEIF(GTYP.EQ.TKIK) THEN 
	   CALL PJKIKRESULTS(FILE,DRAW,GNUM,GIND)
        ELSEIF(GTYP.EQ.TSPT) THEN 
	   CALL PJSPTRESULTS(FILE,DRAW,GNUM,GIND)
        ELSEIF(GTYP.EQ.TPAS) THEN
           CALL PJPASRESULTS(FILE,DRAW,GNUM,GIND)
	ELSE
