C
C SUBROUTINE EURGOPTCTR
C
C V01 15-MAR-2016 SCML CREATION (M16 PROJECT)
C
C SUBROUTINE TO ADD GAME OPTION DATA TO CTR MESSAGES OF GAMES OF
...
C=======OPTIONS /CHECK=NOOVERFLOW/EXT
        SUBROUTINE EURGOPTCTR(MESTAB, MESIND, EGNUM)
        IMPLICIT NONE
C
...
C
        IF(GTYP.EQ.TEUM) THEN                                                   !EUM GAME TYPE
          IF(GIND.GE.1 .AND. GIND.LE.ENUMEUM) THEN
            I4TEMP = EUMGOPTCTR(GIND)                                           !CTR GAME OPTION FLAGS
            MESTAB(MESIND+0) = I1TEMP(2)
            MESTAB(MESIND+1) = I1TEMP(1)
            MESIND = MESIND + 2
C
            IF(IAND(EUMGOPTCTR(GIND), BETLIM_OPT).NE.0) THEN                    !MAX BET LIMIT PRESENT
            ...
            ENDIF
C
            IF(IAND(EUMGOPTCTR(GIND), MAXFRA_OPT).NE.0) THEN                    !MAX NUMBER OF FRACTIONS PRESENT
              I4TEMP = EUMMAXFRAC(GIND)
              MESTAB(MESIND+0) = I1TEMP(1)
              MESIND = MESIND + 1
            ENDIF
C
            IF(IAND(EUMGOPTCTR(GIND), MDRBIT_OPT).NE.0) THEN                    !MULTI-DRAW BITMAP PRESENT
               DO I = 1,EMAXDBM
            ...
            ENDIF
C
            IF(IAND(EUMGOPTCTR(GIND), TKTCHA_OPT).NE.0) THEN                    !TICKET CHARGE PRESENT
            ...
            ENDIF
C
            IF(IAND(EUMGOPTCTR(GIND), CTRREV_OPT).NE.0) THEN                    !CONTROL REVISION PRESENT
            ...
            ENDIF
C
            IF(IAND(EUMGOPTCTR(GIND), TXTREV_OPT).NE.0) THEN                    !TEXT REVISION PRESENT
            ...
            ENDIF
C
            IF(IAND(EUMGOPTCTR(GIND), TTXREV_OPT).NE.0) THEN                    !TICKET TEXT REVISION PRESENT
        ...
        ELSEIF(GTYP.EQ.TRAF) THEN                                               !RAF GAME TYPE
          IF(GIND.GE.1 .AND. GIND.LE.ENUMRAF) THEN
            I4TEMP = RAFGOPTCTR(GIND)                                           !CTR GAME OPTION FLAGS
            MESTAB(MESIND+0) = I1TEMP(2)
            MESTAB(MESIND+1) = I1TEMP(1)
            MESIND = MESIND + 2
C
            IF(IAND(RAFGOPTCTR(GIND), BETLIM_OPT).NE.0) THEN                    !MAX BET LIMIT PRESENT
            ...
            ENDIF
C
            IF(IAND(RAFGOPTCTR(GIND), MAXFRA_OPT).NE.0) THEN                    !MAX NUMBER OF FRACTIONS PRESENT
              I4TEMP = RAFMAXFRAC(GIND)
              MESTAB(MESIND+0) = I1TEMP(1)
              MESIND = MESIND + 1
            ENDIF
C
            IF(IAND(RAFGOPTCTR(GIND), MDRBIT_OPT).NE.0) THEN                    !MULTI-DRAW BITMAP PRESENT
               DO I = 1,EMAXDBM
            ...
            ENDIF
C
            IF(IAND(RAFGOPTCTR(GIND), TKTCHA_OPT).NE.0) THEN                    !TICKET CHARGE PRESENT
            ...
            ENDIF
C
            IF(IAND(RAFGOPTCTR(GIND), CTRREV_OPT).NE.0) THEN                    !CONTROL REVISION PRESENT
            ...
            ENDIF
C
            IF(IAND(RAFGOPTCTR(GIND), TXTREV_OPT).NE.0) THEN                    !TEXT REVISION PRESENT
            ...
            ENDIF
C
            IF(IAND(RAFGOPTCTR(GIND), TTXREV_OPT).NE.0) THEN                    !TICKET TEXT REVISION PRESENT
