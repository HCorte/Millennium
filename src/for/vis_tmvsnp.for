...
C SUBROUTINE TMVSNP
C
C V03 08-JUN-2000 UXN FTNAMES.DEF added.
C V02 31-MAY-2000 PXO Subroutine name SSSSNP -> TMVSNP
...
9001    FORMAT ('Super Score Game Sales for',7A2,'*')
