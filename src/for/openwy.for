C
C SUBROUTINE OPENWY
C $Log:   GXAFXT:[GOLS]OPENWY.FOV  $
C  
C     Rev 1.0   17 Apr 1996 14:18:54   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   09 Mar 1994 13:03:04   JXP
C  Initial revision.
C  
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE OPENWY(LUN, I4FILE, SHRIND, DUM1, DUM2, ST)
	IMPLICIT NONE
C
...
1200	CONTINUE
	XLEN = MAX(K-1,1)
	CALL OPENXY(LUN, CXNAME(1:XLEN), SHRIND, DUM1, DUM2, ST)
C
	RETURN
	END	
