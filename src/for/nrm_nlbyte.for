C
C SUBROUTINE NLBYTE
C $Log:   GXAFXT:[GOLS]NLBYTE.FOV  $
C  
C     Rev 1.0   17 Apr 1996 14:12:26   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 17:07:10   DAB
C  Initial Release
C  Based on Netherlands Bible, 12/92, and Comm 1/93 update
C  DEC Baseline
C
C ** Source - nrm_nlbyte.for **
C
C VAX_NLBYTE.FOR
C
...
C
C CALL NLBYTE(I4VAR, ARRAY, BYTENUM)
C
C
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE NLBYTE(I4VAR, ARRAY, BYTENUM)
	IMPLICIT NONE
C
	INTEGER*4	I4VAR
	BYTE		ARRAY(0:*)
