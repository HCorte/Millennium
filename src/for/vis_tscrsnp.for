...
C V03 31-MAY-2000 PXO Subroutine name from TUSLSNP -> TTULSNP
...
9001	FORMAT ('Tulos Game Sales for ',7A2)
...
905     FORMAT(X, 'There Are Not Active Tulos Games, Enter Vision Command')
