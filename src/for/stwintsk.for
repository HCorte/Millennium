...
C 
C SUPER TRIPLE WINNER SELECTION PROCEDURE CONTROL TASK
C
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C---------------------------- Start of code ------------------------------
	...
	CALL PRMYESNO(
     *   'Are you sure you want Super Triple winner selection [Y/N]? ',
     *   FLAG)
...
C---- Load and start STWINSEL task

	WRITE(5,901) IAM(),'STWINSEL '

	CALL RUNTSK(8HSTWINSEL)
...
900	FORMAT(1X,A,' Mount drawing packs and continue STWINTSK ')

901	FORMAT(1X,A,' Begining execution of ',A8)

902	FORMAT(1X,A,' Super Triple winner selection complete ')
