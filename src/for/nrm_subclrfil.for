C
C SUBROUTINE SUBCLRFIL
C $Log:   GXAFXT:[GOLS]SUBCLRFIL.FOV  $
C  
C     Rev 1.0   17 Apr 1996 15:21:40   HXK
C  Release of Finland for X.25, Telephone Betting, Instant Pass Thru Phase 1
C  
C     Rev 1.0   21 Jan 1993 17:45:16   DAB
C  Initial Release
C  Based on Netherlands Bible, 12/92, and Comm 1/93 update
C  DEC Baseline
C
C ** Source - nrm_subclrfil.for **
C
C SUBCLRFIL.FOR
C
C V01 24-OCT-91 TKO Initial release
C
C This is a subroutine which may be called to open & clear a contiguous file
C as fast as possible (I think).
C
C It is called by CLRFIL and MAKFIL (via NEWFIL)
C
C
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE SUBCLRFIL(LUN, FILENAME, ST)
	IMPLICIT NONE
C
