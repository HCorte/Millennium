...
C PROGRAM SWINTSK
C  
C SCORE WINNER SELECTION PROCEDURE CONTROL TASK
C
C
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C
	...
	CALL CLOSEFIL(FDB)
	CALL PRMYESNO(
     *   'Are you sure you want Score winner selection [Y/N]? ',
     *   FLAG)
...
C
C
C LOAD AND START SWINSEL TASK
C
	WRITE(5,901) IAM(),'SWINSEL  '
	CALL RUNTSK(8HSWINSEL )
	WRITE(5,902) IAM()
C
