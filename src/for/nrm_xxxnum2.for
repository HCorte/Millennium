C
C SUBROUTINE XXXNUM2
C
C Creation date: 28-MAR-2008
C
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
C=======OPTIONS /CHECK=NOOVERFLOW
	SUBROUTINE XXXNUM2(PRMFLG, STRING,NUM,LOW,HIGH,EXT)
	IMPLICIT NONE
C
...
C
	...
	ENDIF
C
C CHECK FOR 'S'         Created in 2008/03/28
C
	IF(CBUF(1).EQ.'S'.OR.CBUF(1).EQ.'s') THEN
	   EXT=-13
	   GOTO 8888
	ENDIF
C
